   ...
   <section class="bg-gray-100 min-h-screen flex box-border justify-center items-center">
    <div class="bg-[#4bc3d0] rounded-2xl flex max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8">
            ...
            <p class="text-sm mt-4 text-[#002D74]">Login dulu yaa.</p>
            ...
            <div class="mt-4 text-sm flex justify-between items-center container-mr">
              ...
              <a href="{{ route('register') }}" class="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">
                 Register</a>
            </div>
        </div>
